    ...
    2: [
      function (require, module, exports) {
        ...
        function initMap() {
          ...
          let srcAutocomplete = new google.maps.places.Autocomplete(source);

          var destination = document.getElementById("destination");
          let dstnAutocomplete = new google.maps.places.Autocomplete(
            destination
          );
          ...
          directionsService.route(request, function (result, status) {
            ...
            for (let j = 0; j < waypoints.length; j += 5) {
                          ...
                          if (origin != null && destination != null) {
                            ...
                            directionsService.route(
                              ...
                              function (result, status) {
                                console.log(result);
                                let di = result.routes[0].legs[0].distance.text;
                                console.log(di);
                                if (status == "OK") {
                                  // alert("distance between this two plaza : " + di);
                                  alert(
                                    "distance between this two plaza : " + di
                                  );
        ...
        script.src =
          "https://maps.googleapis.com/maps/api/js?key=AIzaSyAda4zTN_Eg3hHoML7MYL3N1SQ7BdYsfy0&callback=initMap&libraries=places";
        script.defer = true;
